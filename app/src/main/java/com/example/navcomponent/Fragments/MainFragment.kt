...
class MainFragment : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            R.id.view_transactions_btn -> navController!!.navigate(R.id.action_mainFragment2_to_viewTransactionsFragment22)
            R.id.send_money_btn -> navController!!.navigate(R.id.action_mainFragment2_to_chooseRecipientFragment)
            R.id.view_balance_btn -> navController!!.navigate(R.id.action_mainFragment2_to_viewBalanceFragment2)
        }
    }
}